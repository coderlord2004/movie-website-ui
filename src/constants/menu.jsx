...
const linkIcon = {
    [cinemaMenu[2]]: 'https://img.icons8.com/external-tanah-basah-basic-outline-tanah-basah/24/FFFFFF/external-trending-content-creator-tanah-basah-basic-outline-tanah-basah.png',
    ...
    [userActivitiesMenu[0]]: 'https://img.icons8.com/ios-filled/50/FFFFFF/video-playlist.png',
    [userActivitiesMenu[1]]: 'https://img.icons8.com/ios-filled/50/FFFFFF/repeat.png',
}

export { adminSideBarMenu, adminSideBarMap, cinemaMenu, trendingMenu, movieMenu, tvshowMenu, cinemaMap, linkIcon, userActivitiesMenu }