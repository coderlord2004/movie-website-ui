  ...
  return (
    ...
    >
      <div className={`relative overflow-hidden w-full h-full`}>
        <div className="w-full h-full rounded-[10px] animate-skeleton overflow-hidden flex justify-center items-center">
          <img
            src={
              belongTo === "TMDB_FILM"
      ...
      >
        <p className={`w-[80%] mr-[18px] text-[160%] font-medium`}>
