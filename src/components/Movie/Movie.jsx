        ...
        >
            <div className={`relative overflow-hidden w-full h-auto`}>
                <div className={`w-full aspect-[2/3] rounded-[10px] animate-skeleton`}>
                    <img
                        src={belongTo === 'TMDB_FILM' ? `${image_base_url}original${movieData.poster_path || movieData.backdrop_path}` : `${movieData.posterPath}`}
                        alt="Error"
            ...
            <div className={`flex px-[3px] mt-[4px] justify-between items-start mb-[13px] z-[1]`}>
