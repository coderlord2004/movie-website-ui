...
export default function AdminSideBar({ isOpen, onClose, onUpdateActiveMenu }) {
    ...
    return (
        <div className={"commonColor w-[230px] h-[100%] text-white fixed top-[50px] left-[-40%] sm:left-0 transition-all duration-400 ease-linear z-50 flex flex-col " + `${isOpen ? "" : "transform translate-x-[-100%]"}`}>
            <div
