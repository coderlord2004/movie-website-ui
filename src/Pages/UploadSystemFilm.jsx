...
import { FiImage, FiVideo, FiUpload, FiLoader, FiPlusCircle, FiTrash2 } from 'react-icons/fi';
...
function UploadSystemFilm() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-gray-100">
                ...
                <div className="bg-gray-800 rounded-xl shadow-2xl overflow-hidden">
                    ...
                    <form onSubmit={handleSubmit} className="p-6 space-y-8">
                        ...
                        <div className="space-y-6">
                            ...
                            {/* Title */}
                            <div>
                                <label className="block text-sm font-medium text-gray-400 mb-1">Film Title *</label>
                                <input
                                    type="text"
                                    name="title"
                            ...
                            <div className="relative group flex flex-col gap-y-[10px]">
                                ...
                                <div className="relative bg-gray-700 border-2 border-dashed border-gray-600 rounded-xl flex flex-col items-center justify-center transition hover:border-indigo-500 group-hover:border-indigo-500 overflow-hidden min-h-[150px]">
                                    <div className='flex flex-col items-center justify-center h-full'>
                                        ...
                                        <span className="text-gray-500 text-xs mt-1">Max 100MB</span>
                                    </div>
                                    <input
                                        type="file"
                                        name="video"
            ...
            {cropModal.open && (
                <CropModal cropModal={cropModal} onCancel={setCropModal} onComplete={handleCropDone} />
            )}
        </div>
    );
}
